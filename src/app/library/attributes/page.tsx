...
import AttributesRepository from '@/components/AttributesRepository';
            ...
            <div style={{ flex: 1 }}>
                <div style={{
                    ...
                    <div style={{ textAlign: 'center' }}>
                        <h1 className="gradient-text responsive-h1">Allah's Attributes Archive</h1>
                        <p style={{ color: '#f8f9fa', maxWidth: '800px', margin: '0 auto', fontSize: '1.1rem' }}>
                            A thematic exploration of the Beautiful Names (Asma-ul-Husna) and their manifestation in creation.
                        </p>
                    </div>
                </div>
